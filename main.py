...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self._sampler.disk_sample.connect(self._reporter.on_disk_sample)
        self._sampler.throttle_sample.connect(self._reporter.on_throttle_sample)
        self._sampler.fan_sample.connect(self._reporter.on_fan_sample)
